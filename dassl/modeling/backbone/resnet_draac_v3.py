...
@BACKBONE_REGISTRY.register(nick_name="Block_v3")
...
"""
Residual networks with draac_v3 and mixstyle
"""


@BACKBONE_REGISTRY.register()
def resnet18_draac_v3_ms_l123(pretrain=None, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet18_draac_v3_ms_l12(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet18_draac_v3_ms_l1(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet18_draac_v3(pretrain=None, **kwargs):
    net = ResNetDRA(
        block=BasicBlockKDRN,
        layers=[2, 2, 2, 2],
        pretrain=pretrain
...
@BACKBONE_REGISTRY.register()
def resnet50_draac_v3_ms_l3(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet50_draac_v3_ms_l123(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet50_draac_v3_ms_l12(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet50_draac_v3_ms_l1(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet50_draac_v3(pretrain=None, **kwargs):
    net = ResNetDRA(
        block=BottleneckKDRA,
        layers=[3, 4, 6, 3],
        pretrain=pretrain
...
@BACKBONE_REGISTRY.register()
def resnet101_draac_v3_ms_l123(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet101_draac_v3_ms_l12(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet101_draac_v3_ms_l1(pretrain=None, **kwargs):
    from dassl.modeling.ops import MixStyle
...
@BACKBONE_REGISTRY.register()
def resnet101_draac_v3(pretrain=None, **kwargs):
    net = ResNetDRA(
        block=BottleneckKDRA,
        layers=[3, 4, 23, 3],
        pretrain=pretrain
