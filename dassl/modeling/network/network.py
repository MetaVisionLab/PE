...
def resnet18_cdan(num_classes=7):
    return ResNetFc(resnet_name="ResNet18",
                    use_bottleneck=True, bottleneck_dim=256,
                    new_cls=True, class_num=num_classes)


@NETWORK_REGISTRY.register()
def resnet50_cdan(num_classes=7):
    return ResNetFc(resnet_name="ResNet50",
                    use_bottleneck=True, bottleneck_dim=256,
                    new_cls=True, class_num=num_classes)
...
@NETWORK_REGISTRY.register()
def AdversarialNetwork_cdan(in_feature, hidden_size):
    return AdversarialNetwork(in_feature, hidden_size)
