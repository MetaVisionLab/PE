...
# LWCDA
_C.TRAINER.LWCDA = CN()
_C.TRAINER.LWCDA.SOURCE_ARCH = 'DTN'
_C.TRAINER.LWCDA.SOURCE_EPOCH = 100
_C.TRAINER.LWCDA.G_ARCH = "calibrator"
_C.TRAINER.LWCDA.ARCH = "resnet_9"
_C.TRAINER.LWCDA.NORM_TYPE = "instance"
_C.TRAINER.LWCDA.L_INFTY_NORM = 0.4
_C.TRAINER.LWCDA.CALI_WIDTH_FACTOR = 8
_C.TRAINER.LWCDA.PATCH_SIZE = 4
_C.TRAINER.LWCDA.RESOLUTION = 16
_C.TRAINER.LWCDA.PIXEL_HIDDEN_DIM = 128
_C.TRAINER.LWCDA.USE_SOFTMAX = True
_C.TRAINER.LWCDA.WARMUP = 0
_C.TRAINER.LWCDA.CLAMP = True
_C.TRAINER.LWCDA.CLAMP_MIN = -1
_C.TRAINER.LWCDA.CLAMP_MAX = 1

# DRT
_C.TRAINER.DRT = CN()
_C.TRAINER.DRT.NUM_LAYER = 2
_C.TRAINER.DRT.LMBD = 4
_C.TRAINER.DRT.LBSM = 0.01
_C.TRAINER.DRT.GAMMA = 0.01
_C.TRAINER.DRT.ETA = 50
_C.TRAINER.DRT.NUM_UNIT = 2048
